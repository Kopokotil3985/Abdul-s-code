...
init:
    ...
    $ right2=Position(xaling=0.8, yaling=1.1)
    $ right3=Position(xaling=0.6, yaling=1.1)
label start:
    window hide
    ...
    B "Идея то славная, а как добраться-tо туда?!"
    ...
    scene black with fade
    "В мыслях Йоги:"
    "Я поебался с ней, а забыл про свою цель: где Евдокимова хата?"
    "Ай, была-не была, вон идёт женщина, спрошу у нее."
    scene village_tropa with zoomin
    show Iogan with fade at left
    show Kirillovna with fade at right
    ...
    pause
    scene homeEvdokii with dissolve
    show anastsia with fade at right
    show Iogan with fade at left
    show Egorich with fade at right1
    show Boria with fade at right2
    ...
    If win:
        ...
        "Он налетел на меня с кулаками."
            If win:
                hide Egorich with easeoutright
                "Кровь текла у меня из носа, но в целом ещё мог выдержать натиск пары таких слабачков." 
                "Ну, видно конечно, что пенсионеры, а лезут."
                s"Что ты им наговорила блин? Сама траха…. и жалуется!"
                e"Ты плохой человек, Йога!" 
                " - сказала она, плача."
                s"Еще и ноешь..."
                "Я не знал, как общаться с девушками, а тем более плачущими."
                "Она плакала, я тупо сидел. Глупая картина - так сказал бы каждый, кто ее увидел. Но внутри она была сложная и противоречивая."
                "Время шло. Мы не двигались."
                "Времена мрака начали дуть на колесницу Ра, отчего та убегала быстрее. Время ускорялось. Уже минута - это секунда."
                "У меня в голове полнейшая каша, мысли бегают и бегают."
                If end>3:
                    s"На свои шмотки,"
                    "мягко, трудновыговоримо сказал я, прервав тишину."
                    e"Не надо," 
                    "было сказано весьма обиженно."
                    "Молчание продолжило свое существование. И я решил снова нарушить его."
                    s"А ты прям сильно меня ненавидишь," 
                    "глупый вопрос для обманутого тобой человека."
                    "Прям сильно."
                    "Она сказала это с натяжной серьезностью, {w} но внимательный глаз смог бы разглядеть улыбку на ее лице."
                    "Да, ждет извинений."
                    e"А ты правда где-то работаешь?"
                    "В этот раз начала она сшивать наш разговор."
                    s"Да нет."
                    e"Значит врал," 
                    "грустно сказала она."
                    s"Просто ты мне очень понравилась и я, никчёмный человек, решил выкручиваться."
                    e"Даже ее знаю, стоит ли доверять тебе?"
                    "Вопрос сложный, но мне показалось, что она сама знает на этот вопрос."
                If end<4:
                    "Как меня всё заколебало: ты, все эти пенсы, вообще все эти правила жизни!"
                    "Все по правилам, как куклы в спектакле, а кто нами руководит?"
                    "С этими словами я вышел из дома, взял свои пожитки, рюкзачок с едой, одежонку, сел на велосипед и поехал в неизвестность."
                    "Ехать не хотелось. А паршивые кошки своими когтями разрывают мне душу на части!"
                    "Да пошло всё это!"
            else:
                hide Iogan with easeoutbottom
                E"Давай, Настя, помоги Борьку положить и осмотреть!"
                e"Дак, я же голая!"
                E"Ой, а что я там не видел, своя баба есть. Давай, давай, тут человек умирает!"
                e"Я, постаравшись натянуть одеяло как плащ, подошла к Егорычу, уже рассматривающему дядю Борю."
                E"Да, вмятина на лбу, губа разбита, да и бока размяты. Жить будет! Давай бери за ноги!"
                e"Оголятся что-ли?"
                E"Ладно," 
                E"Да, стесняшка наша, сам справлюсь!"
                "Он дотащил его до кровати, положил."
                E"А где этот борец?"
                e"Незнаю,"
                "сказала я."
                e"Убежал."
                E"Далеко не мог. Я его хорошо помял."
                "Мы вышли из дома."
                "По крови можно было понять, что Йога начал двигаться в лес. Мы с Егорычем туда и направились." 
                "Стоит отметить, что ёлки в нашем лесу растут не сплошняком, а редко."
                "Приятно идти по лесу. Так начинаются почти все тексты диктантов в начальной школе. Но реально мне было трудно сказать что-то другое."
                "Приятно и свободно в душе, {w} всё."
                "След Иоганна потерялся, скрылся подлец!"
                "А Егорыч начал напевать какую-то песню:"
                E"Ах, лес широкий,глубокий. Во дремучем то лесу медведь то спал. Спаал, спаал. {w} Уж зайдешь ты в тот лес и пропадешь, пропадешь!"
                E"Ах, ты лес, могучий, ах ты лес дремучий! Ух, тропа петлявая, ух, изба корявая! Баба Яга - Костяная нога! {w} Ай, ай, ой, страшно!"
                E"Бом, бум, бом, бум. Леший, Леший, не ходи по той тро́пе, поедет младой молодец и разрубит тебя на кусочки, на кусочки!"
                E"Леес не шуми, не веселись, опрокиньте головы, ели сильные, красные! Опрокинь ветку, дуб-великан! Ведь лежит на тро́пе младой человек."
                E"Вся кровушка вытекла, потекли ручьи, и река потекла. Во́ море синее вольётся она! Грустит лес, плачут берёзки по красавцу́-удальцу́, одна сосна, стара бабка с серпом-суком руки потирает, радуются иголочки: умерщвлен он, умерщвлен!"
                E"Бом! Бах! Бум! Бом!"
                "Вернулись мы домой, так и ничего не узнав о Иоганне."
    else:
        hide Iogan with easeoutbottom
        B"Ух, тяжеловат, но я то ещё тяжелее!"
        E"Да, славно ты ему задал, пошли что-ли грузить его на мой мопед."
        B"Эх, взяли, и раз, ииии два, иии раз…"
        "Они дотащили и погрузили тело Йоги. О, как противно мне было выговорить имя лжеца! "
        E"Давай отвезем его в сторожку, и закроем, приедет милиция и разберётся с ним."
        B"Уже везу, а ты пока с Настей посиди и успокой."
        pause
        scene turma
        "Прошло два дня и вылетает табличка с надписью "лишение свободы на 3 года", а все это на фоне судебного зала, где Йога серьёзен и с капелькой грустинки."
        "Йога находится в тюрьме уже неделю и осмыслил очень много чего, то, что он не нужен обществу, то, что он бездарь и ничего не умеет."
        "Сии грустные мысли…"
        If end>3:
            show Iogan with fade
            "...все равно не сломили дух Иоганна."
            "Он решил отсидеть, максимально тихо и правильно, развиваться и начать новую жизнь."
            "Каждый день перед его глазами возникала она, которую он не просто использовал, он чувствовал какое-то влечение к её скромной буйности, к ней."
            "Он решил досидеть до конца!"
        If end<4:
            show Iogan with fade
            "...угнетали. Иоганн впадал в бессилие, он не мог победить силы зла."
            "Он мучился, худел. Его облик стал болезненным. Тощий человек сидел в камере."
            "Ему уже давали и пищу, и сводили к психологу, и освободили от работ, но ничего не помогало против внутреннего удушения. {w} Что случилось в ночь на 23 августа."
            "Демон прилетел за ним.  {w}Взял и унес!"
            hide Iogan with easeouttop
            
#Вот и сказочке конец, а кто читал внимательно - шикарный пупс!
