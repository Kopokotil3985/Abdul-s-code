...
label start:
    ...
    nvl clear
    n "Детство моё проходило на морском побережье в Астраханской области."
    n "Отец - рыбак, много пил."
    n "А мать боролась с ним и рано умерла, но была злой."
    n "Я свернул на плохую дорожку."
    n "Чайки, ветер, волны, шторм- самое приятное воспоминание из детства."
    n "Берег, крабы, кабаки."
    n "Поворот на дорогу пьянства, зла и дьявола. "
    n "Черти ходят вокруг меня."
    n "Зона, Березники, шесть лет."
    n "Пьянство, автобус и в Пермь."
    n "Пьян, {w}трезв, {w}пьян."
    n "И опа - долг."
    n "Картишки, {w}долг."
    n "Покер, {w}долг."
    n "Ставки, {w}долг."
    n "Вначале везло, а потом нет."
    n "Должище накопился размером с Евразию."
    n "Беру кредит, скрытность от ментов."
    n "Одиночество и на дно."
    n "Углубляется в днище жизни."
    n "Проститутки каждый день."
    n "Деньги закончились."
    n "Днище."
    n "Жизнь надоела."
    n "Не могууууууууууууууу."
    n "Днище. {w}Долг. {w}Грабеж.{w} Побег."
    n "Пришлось бежать в лес, вышел на остановке 666 автобуса, загородный какой-то. {w}Статуя Зевса."
    n "Свет."
    n "Ночь."
    n "Свет."
    n "Страх."
    n "Прячусь."
    n "Страх."
    n "Я увидел мощь природы и выбросил деньги и статуйку."
    n "А может и не из-за этого ?!"
    n "Село."
    n "Предгорья."
    n "Путь."
    n "Урал."
    n "Хижина."
    n "Жители."
    n "Есть среди них деды, бабки, девушки и парни, дети - сплошная деревенщина."
    n "Есть умный приезжий священник, но взяточник."
    n "Есть девушка, весьма привлекательная, из города, приехала \"к бабушке\", но нет у нее здесь бабушки, врёт. "
    #"Бой начинается!"
